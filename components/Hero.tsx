  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 flex flex-col items-center text-center">
        ...
        >
          <span className="block italic font-light text-5xl md:text-7xl lg:text-8xl text-cream-200 mb-2">
            The Vision of
          </span>
          Priyadharshika
        </h1>
        ...
        >
          Curating high-converting, aesthetic visual stories for beauty,
          fashion, and lifestyle brands. Where{" "}
          <span className="text-gold-400 font-normal">elegance</span> meets{" "}
          <span className="text-gold-400 font-normal">performance</span>.
        </p>
      ...
      <div
        className="absolute bottom-10 left-10 md:left-20 hidden md:block animate-fade-in opacity-0"
        style={{ animationDelay: "1.2s" }}
      >
        <div className="backdrop-blur-md bg-white/5 border border-white/10 p-4 rounded-lg">
          <p className="text-gold-400 text-xs tracking-widest mb-1">
            CURRENTLY
          </p>
          <p className="text-cream-100 text-sm font-serif italic">
      ...
      <div
        className="absolute bottom-10 right-10 md:right-20 hidden md:block animate-fade-in opacity-0"
        style={{ animationDelay: "1.4s" }}
      >
        <div className="flex items-center gap-4">
          <span className="text-cream-200/40 text-xs tracking-widest uppercase rotate-270 origin-right">
            Scroll
          </span>
